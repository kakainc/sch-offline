...
export PYTHONPATH=../:../../
pythonenv2="/Users/kaka/PycharmProjects/Sch_Offline/venv/bin/python"

start_unix=`date +%s`
echo "update_post_data"

${pythonenv2} post_info_mongo.py '../datas/raw_data/search_demp_test_case.csv'
echo "update post info done"

${pythonenv2} post_ctr_redis.py '../datas/raw_data/search_demp_test_case.csv'
echo "update post ctr done"

${pythonenv2} post_review_redis.py '../datas/raw_data/search_demo_test_case.csv'
...
${pythonenv2} inv_content_redis.py '../datas/raw_data/search_demo_test_case.csv' '../datas/phase_py.txt' '../datas/stopword.txt'
end_unix1=`date +%s`
spent_time1=$(($end_unix1 - $start_inv_unix))
echo "content cut done, spend time: ${spent_time1}!!!"

${pythonenv2} inv_comment_redis.py '../datas/raw_data/search_demo_test_case.csv' '../datas/phase_py.txt' '../datas/stopword.txt'
end_unix2=`date +%s`
spent_time2=$(($end_unix2 - $end_unix1))
echo "comment cut done, spend time: ${spent_time2}!!!"

${pythonenv2} inv_tname_redis.py '../datas/raw_data/search_demo_test_case.csv' '../datas/phase_py.txt' '../datas/stopword.txt'
end_unix3=`date +%s`
